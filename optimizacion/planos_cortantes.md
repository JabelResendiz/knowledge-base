...
1. Se usa para restricciones de entero
...
>>>>>>> c73fddbc0e8a06171928411f16a233b4fd503ee0
>>>>>>>
>>>>>>
>>>>>
>>>>
...
$$
\sum_{j \in R_1} f_{ij}x_j + \sum_{j \in R_{2}^{+}}y_{ij}v_{j} - \frac{f_{i0}}{1-f_{i0}}\sum_{j \in R_{2}^{-}}y_{ij}v_{j} \geq f_{i0}
$$
