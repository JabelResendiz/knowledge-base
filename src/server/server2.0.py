...
class MyHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        response_body = b'Hello, GET!'
        self.send_response(200)
        self.send_header("Content-Length", str(len(response_body)))  # Agregar Content-Length
        self.end_headers()
        self.wfile.write(response_body)  # Escribe el cuerpo de la respuesta
...
if __name__ == "__main__":
    server = ThreadedHTTPServer(('0.0.0.0', 8000), MyHTTPRequestHandler)  # Crea un servidor en localhost en el puerto 8000
